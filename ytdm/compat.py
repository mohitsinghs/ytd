...
try:
    ...
    # is apparently broken (see https://github.com/ytdl-org/ytdm/pull/6244)
...
# Fix https://github.com/ytdl-org/ytdm/issues/4223
...
if platform.python_implementation() == 'PyPy' and sys.pypy_version_info < (5, 4, 0):
    ...
    # names, see the original PyPy issue [1] and the ytdm one [2].
    # 1. https://bitbucket.org/pypy/pypy/issues/2360/windows-ctypescdll-typeerror-function-name
    # 2. https://github.com/ytdl-org/ytdm/pull/4392
