...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _formats = {
        ...
        '138': {'ext': 'mp4', 'format_note': 'DASH video', 'vcodec': 'h264'},  # Height can vary (https://github.com/ytdl-org/ytdm/issues/4559)
    ...
    _TESTS = [
        {
            ...
            'info_dict': {
                ...
                'description': 'test chars:  "\'/\\ä↭𝕐\ntest URL: https://github.com/rg3/ytdm/issues/1892\n\nThis is a test video for ytdm.\n\nFor more information, contact phihag@phihag.de .',
        ...
        # video_info is None (https://github.com/ytdl-org/ytdm/issues/4421)
        ...
        # Olympics (https://github.com/ytdl-org/ytdm/issues/4431)
        {
            'url': 'lqQg6PlCWgI',
            'info_dict': {
                'id': 'lqQg6PlCWgI',
        ...
        # Extraction from multiple DASH manifests (https://github.com/ytdl-org/ytdm/pull/6097)
        {
        ...
        {
            # Multifeed video with comma in title (see https://github.com/ytdl-org/ytdm/issues/8536)
        ...
        {
            # Title with JS-like syntax "};" (see https://github.com/ytdl-org/ytdm/issues/7468)
            # Also tests cut-off URL expansion in video description (see
            # https://github.com/ytdl-org/ytdm/issues/1892,
            # https://github.com/ytdl-org/ytdm/issues/8164)
        ...
        {
            # Tags with '};' (see https://github.com/ytdl-org/ytdm/issues/7468)
        ...
        {
            # YouTube Red paid video (https://github.com/ytdl-org/ytdm/issues/10059)
    ...
    def _get_ytplayer_config(self, video_id, webpage):
        patterns = (
            ...
            # https://github.com/ytdl-org/ytdm/issues/7468,
            # https://github.com/ytdl-org/ytdm/pull/7599)
    ...
    def _real_extract(self, url):
        ...
        if re.search(r'player-age-gate-content">', video_webpage) is not None:
            ...
            if ytplayer_config:
                ...
                # https://github.com/ytdl-org/ytdm/issues/10532)
            ...
            if not video_info or self._downloader.params.get('youtube_include_dash_manifest', True):
                ...
                # video with such 'manifest behavior' see https://github.com/ytdl-org/ytdm/issues/6093)
                ...
                for el in ('embedded', 'detailpage', 'vevo', ''):
                    ...
                    if get_token:
                        ...
                        # any complaint (see https://github.com/ytdl-org/ytdm/issues/7362,
            ...
            if not self._downloader.params.get('noplaylist'):
                ...
                if multifeed_metadata_list:
                    ...
                    for feed in multifeed_metadata_list.split(','):
                        ...
                        # https://github.com/ytdl-org/ytdm/issues/8536)
        ...
        if 'ypc_video_rental_bar_text' in video_info and 'author' not in video_info:
            raise ExtractorError('"rental" videos not supported. See https://github.com/ytdl-org/ytdm/issues/359 for more information.', expected=True)
        ...
        if 'conn' in video_info and video_info['conn'][0].startswith('rtmp'):
            ...
            if 'rtmpe%3Dyes' in encoded_url_map:
                raise ExtractorError('rtmpe downloads are not supported, see https://github.com/ytdl-org/ytdm/issues/343 for more information.', expected=True)
            formats = []
            formats_spec = {}
            ...
            for fmt in streaming_formats:
                ...
                # lack metadata (see https://github.com/ytdl-org/ytdm/pull/5993).
        ...
        if self._downloader.params.get('youtube_include_dash_manifest', True):
            ...
            for mpd_url in dash_mpds:
                ...
                if dash_formats:
                    ...
                    # https://github.com/ytdl-org/ytdm/issues/5774 for an
                    # example.
...
class YoutubePlaylistIE(YoutubePlaylistBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        # https://github.com/ytdl-org/ytdm/issues/21844
    ...
    def _extract_playlist(self, playlist_id):
        ...
        # the yt-alert-message now has tabindex attribute (see https://github.com/ytdl-org/ytdm/issues/11604)
    ...
    def _real_extract(self, url):
        ...
        # https://github.com/ytdl-org/ytdm/issues/10537).
...
class YoutubeSearchURLIE(YoutubeSearchBaseInfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://www.youtube.com/results?baz=bar&search_query=ytdm+test+video&filters=video&lclk=video',
        'playlist_mincount': 5,
        'info_dict': {
            'title': 'ytdm test video',
        }
    }, {
