Using the ``ytdm`` module
===============================

When using the ``ytdm`` module, you start by creating an instance of :class:`YoutubeDL` and adding all the available extractors:

.. code-block:: python

    >>> from ytdm import YoutubeDL
    >>> ydl = YoutubeDL()
